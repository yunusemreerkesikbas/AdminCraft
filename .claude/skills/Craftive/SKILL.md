...
```text
"sync landing lockfile with Next 15 dependencies"
```

*Commit message example*

```text
Update configuration and improve landing page structure
```
...
**Example commit sequence**:
```
feature/CMS-192 feat: initialize Next.js landing project with essential configurations and components
