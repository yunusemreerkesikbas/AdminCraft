...
public class MediaFile {
    ...
    public String getAltText(Language language) {
        return switch (language) {
            case TR -> altTextTr;
            case EN -> altTextEn;
            case AR, ES, RU -> altTextTr; // fallback to TR for unsupported languages
        };
    }
    ...
    public String getDescription(Language language) {
        return switch (language) {
            ...
            case AR, ES, RU -> descriptionTr; // fallback to TR for unsupported languages
        };
    }
    ...
    public String getTitle(Language language) {
        return switch (language) {
            case TR -> titleTr;
            case EN -> titleEn;
            case AR, ES, RU -> titleTr; // fallback to TR for unsupported languages
        };
    }
