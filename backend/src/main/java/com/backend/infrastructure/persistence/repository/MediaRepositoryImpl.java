...
public class MediaRepositoryImpl implements MediaRepository {
    ...
    @Override public List<MediaFile> findByTenantIdAndFileSizeBetween(Long tenantId, Long minSize, Long maxSize) { return mediaJpaRepository.findByTenantIdAndFileSizeBetween(tenantId, minSize, maxSize); }
    ...
    @Override public List<MediaFile> findByTenantIdAndFolder(Long tenantId, String folder) { return mediaJpaRepository.findByTenantIdAndFolder(tenantId, folder); }
    @Override public List<MediaFile> findByTenantIdAndCategory(Long tenantId, String category) { return mediaJpaRepository.findByTenantIdAndCategory(tenantId, category); }
    @Override public List<MediaFile> findByTenantIdAndFolderAndCategory(Long tenantId, String folder, String category) { return mediaJpaRepository.findByTenantIdAndFolderAndCategory(tenantId, folder, category); }
    ...
    @Override public List<MediaFile> findByTenantIdAndIsPublicTrue(Long tenantId) { return mediaJpaRepository.findByTenantIdAndIsPublic(tenantId, true); }
    @Override public List<MediaFile> findByTenantIdAndIsPublicFalse(Long tenantId) { return mediaJpaRepository.findByTenantIdAndIsPublic(tenantId, false); }
    ...
    @Override public List<MediaFile> findByTenantIdAndStorageProvider(Long tenantId, String storageProvider) { return mediaJpaRepository.findByTenantIdAndStorageProvider(tenantId, storageProvider); }
    ...
    @Override public List<MediaFile> findByTenantIdAndUploadedBy(Long tenantId, Long userId) { return mediaJpaRepository.findByTenantIdAndUploadedBy(tenantId, userId); }
    @Override public long countByTenantIdAndUploadedBy(Long tenantId, Long userId) { return mediaJpaRepository.countByTenantIdAndUploadedBy(tenantId, userId); }
    @Override public List<MediaFile> findByTenantIdAndOriginalNameContainingIgnoreCase(Long tenantId, String originalName) { return mediaJpaRepository.findByTenantIdAndOriginalNameContainingIgnoreCase(tenantId, originalName); }
    ...
    @Override public List<MediaFile> findByTenantIdAndUsageCountGreaterThan(Long tenantId, Integer count) { return mediaJpaRepository.findByTenantIdAndUsageCountGreaterThan(tenantId, count); }
    ...
    @Override public List<MediaFile> findByTenantIdAndCreatedAtBetween(Long tenantId, LocalDateTime startDate, LocalDateTime endDate) { return mediaJpaRepository.findByTenantIdAndCreatedAtBetween(tenantId, startDate, endDate); }
    ...
    @Override public List<MediaFile> findByTenantIdAndIsOptimizedTrue(Long tenantId) { return mediaJpaRepository.findByTenantIdAndIsOptimized(tenantId, true); }
    @Override public List<MediaFile> findByTenantIdAndIsOptimizedFalse(Long tenantId) { return mediaJpaRepository.findByTenantIdAndIsOptimized(tenantId, false); }
    ...
    @Override public void deleteByTenantId(Long tenantId) { mediaJpaRepository.deleteByTenantId(tenantId); }
    ...
    @Override public long countByTenantIdAndMimeTypeStartingWith(Long tenantId, String mimeTypePrefix) { return mediaJpaRepository.countByTenantIdAndMimeTypeStartingWith(tenantId, mimeTypePrefix); }
    @Override public long countByTenantIdAndCreatedAtBetween(Long tenantId, LocalDateTime startDate, LocalDateTime endDate) { return mediaJpaRepository.countByTenantIdAndCreatedAtBetween(tenantId, startDate, endDate); }
