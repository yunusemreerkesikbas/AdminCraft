...
public class ComponentEntryController {
    ...
    public ResponseEntity<ApiResponse<ComponentEntryResponse>> createEntry(
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.CREATED)
                    .body(ApiResponse.success(successMessage, ComponentEntryResponse.from(created)));
        } catch (Exception ex) {
    ...
    public ResponseEntity<ApiResponse<ComponentEntryResponse>> getEntry(
        ...
        try {
            ...
            String successMessage = messageSource.getMessage("component.entry.get.success",
                    null, Locale.forLanguageTag(lang));
            return ResponseEntity.ok(ApiResponse.success(successMessage, ComponentEntryResponse.from(entry)));
        } catch (Exception ex) {
    ...
    public ResponseEntity<ApiResponse<ComponentEntryResponse>> updateEntry(
        ...
        try {
            ...
            if (request.isVisible() != null) entry.setIsVisible(request.isVisible());
            if (request.styleClasses() != null) entry.setStyleClasses(request.styleClasses());
            ...
            String successMessage = messageSource.getMessage("component.entry.update.success",
                    null, Locale.forLanguageTag(lang));
            return ResponseEntity.ok(ApiResponse.success(successMessage, ComponentEntryResponse.from(updated)));
        } catch (Exception ex) {
