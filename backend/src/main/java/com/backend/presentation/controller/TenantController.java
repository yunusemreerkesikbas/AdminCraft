...
public class TenantController {
    ...
    public ResponseEntity<ApiResponse<TenantResponse>> createTenant(
        ...
        try {
            ...
            String message = messageSource.getMessage("tenant.create.error", new Object[] { ex.getMessage() },
                    Locale.forLanguageTag(languageCode));
    ...
    public ResponseEntity<ApiResponse<TenantResponse>> updateTenant(
        ...
        try {
            ...
            String message = messageSource.getMessage("tenant.update.error", new Object[] { ex.getMessage() },
                    Locale.forLanguageTag(languageCode));
            return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                    .body(ApiResponse.error(message));
        }
    ...
    public ResponseEntity<ApiResponse<Void>> deleteTenant(
        ...
        try {
            ...
            String message = messageSource.getMessage("tenant.delete.error", new Object[] { ex.getMessage() },
                    Locale.forLanguageTag(languageCode));
            return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                    .body(ApiResponse.error(message));
        }
    ...
    // Removed legacy endpoints (activate/suspend/maintenance/subdomain/stats)
}