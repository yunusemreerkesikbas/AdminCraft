...
@Validated
public class TenantMailMarketingController {
    ...
    public ResponseEntity<ApiResponse<MailProviderConfigDto>> getProviderConfig() {
        try {
            return ResponseEntity.ok(ApiResponse.success(
                message("mail.marketing.provider.fetched"),
    ...
    @PreAuthorize("hasRole('TENANT_ADMIN')")
    public ResponseEntity<ApiResponse<MailProviderConfigDto>> upsertProviderConfig(
        @Valid @RequestBody UpsertProviderConfigRequest request
    ) {
        try {
            return ResponseEntity.ok(ApiResponse.success(
                message("mail.marketing.provider.saved"),
                service.upsertProviderConfig(
                    request.fromEmail(),
                    request.fromName(),
                    request.serverToken(),
                    request.active()
