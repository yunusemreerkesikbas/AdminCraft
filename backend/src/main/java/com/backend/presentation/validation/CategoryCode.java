 ...
 * Category code must start with lowercase letter and contain only lowercase letters,
 * digits, underscores, and hyphens.
 *
 * <p>Use this annotation for Category codes where hyphens are allowed.</p>
 *
 * <p>Pattern: ^[a-z][a-z0-9_-]*$</p>
 *
 * <p>Examples of valid codes: "electronics-main", "clothing_men", "home-decor", "a1"</p>
 * <p>Examples of invalid codes: "1category", "Category", "code.name", ""</p>
 *
