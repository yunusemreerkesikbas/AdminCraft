 ...
 * This prevents URL injection attacks and ensures only trusted domains are accepted
 */
    ...
    public boolean isValid(String url, ConstraintValidatorContext context) {
        ...
        if (!isAllowed) {
            ...
            context.buildConstraintViolationWithTemplate(
                "URL domain '" + domain + "' is not in the allowed whitelist"
