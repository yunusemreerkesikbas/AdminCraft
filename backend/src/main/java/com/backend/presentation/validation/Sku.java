 ...
 * SKU can contain letters (uppercase and lowercase), digits, underscores, and hyphens.
 *
 * <p>Use this annotation for Product SKU fields.</p>
 *
 * <p>Pattern: ^[A-Za-z0-9_-]+$</p>
 *
 * <p>Examples of valid SKUs: "SKU-12345", "PROD_001", "ABC123", "item-1_v2"</p>
 * <p>Examples of invalid SKUs: "SKU 123", "item.name", "", "product@123"</p>
 *
 * @see SkuValidator
 */
@Documented
