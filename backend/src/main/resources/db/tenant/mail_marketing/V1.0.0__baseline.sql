...
-- 3. Newsletter Subscriber Subscriptions
CREATE TABLE newsletter_subscriber_subscriptions (
    ...
    INDEX idx_newsletter_subscriber_template_lang (template_key, preferred_language),
    INDEX idx_newsletter_subscriber_template_permission_lang (template_key, permission, preferred_language),
    CONSTRAINT fk_newsletter_subscriber_subscription_subscriber
        FOREIGN KEY (subscriber_id) REFERENCES newsletter_subscribers(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- 4. Mail Provider Config
