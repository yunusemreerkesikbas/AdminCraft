...
FROM (
  SELECT 'b1200001-0000-4000-8000-000000000001' AS uuid, 'AboutHeroComponentTr' AS uid, 'AboutHeroComponent' AS component_uid, 'TR' AS language, 'Building Digital Presence' AS title, 'Digital creative agency' AS subtitle, 'Digital experiences with maximum emotional impact' AS description
  ...
  UNION ALL SELECT 'b1200003-0000-4000-8000-000000000003', 'AboutStoryComponentTr', 'AboutStoryComponent', 'TR', 'Something', 'What I Do', 'We are a creative studio that specializes in providing high-quality design and branding solutions to businesses and individuals.
...
Our team is composed of talented designers, developers, and marketers who shape memorable digital brands and polished product experiences.'
  UNION ALL SELECT 'b1200005-0000-4000-8000-000000000005', 'AboutTeamSectionTr', 'AboutTeamSection', 'TR', 'Meet the people behind every launch', 'Our team', NULL
  ...
  UNION ALL SELECT 'b1200007-0000-4000-8000-000000000007', 'AboutStatsSectionTr', 'AboutStatsSection', 'TR', 'Agency snapshots', 'Fun facts', NULL
  ...
  UNION ALL SELECT 'b1200009-0000-4000-8000-000000000009', 'AboutBrandsStripTr', 'AboutBrandsStrip', 'TR', 'Our clients', 'Trusted by', 'We believe in creating partnerships based on honesty and true connection. That is why some of the biggest companies stayed with us for years.'
  ...
  UNION ALL SELECT 'b1200011-0000-4000-8000-000000000011', 'AboutAwardsBlockTr', 'AboutAwardsBlock', 'TR', 'Awards & Recognitions', 'Our awards', 'Recognition collected across design, storytelling, and digital craft.'
...
FROM (
  SELECT 'b1400001-0000-4000-8000-000000000001' AS uuid, 'AboutHeroPrimaryTr' AS uid, 'AboutHeroPrimary' AS entry_uid, 'TR' AS language, 'About hero background' AS title, 'Liko develops, designs and delivers websites and creative campaigns that drive results.' AS description, JSON_OBJECT('mediaUid', 'about-hero-bg', 'buttonText', 'Our Story', 'buttonUrl', '#AboutStoryComponent', 'supportingText', 'Liko develops, designs and delivers websites and creative campaigns that drive results.', 'scrollTarget', 'AboutStoryComponent') AS custom_data
  ...
  UNION ALL SELECT 'b1400003-0000-4000-8000-000000000003', 'AboutStoryMedia1Tr', 'AboutStoryMedia1', 'TR', 'Studio portrait', NULL, JSON_OBJECT('mediaUid', 'about-story-1', 'introLabel', 'Hi!')
  ...
  UNION ALL SELECT 'b1400005-0000-4000-8000-000000000005', 'AboutStoryMedia2Tr', 'AboutStoryMedia2', 'TR', 'Creative studio', NULL, JSON_OBJECT('mediaUid', 'about-story-2')
  ...
  UNION ALL SELECT 'b1400007-0000-4000-8000-000000000007', 'AboutStoryMedia3Tr', 'AboutStoryMedia3', 'TR', 'Product collaboration', NULL, JSON_OBJECT('mediaUid', 'about-story-3')
  ...
  UNION ALL SELECT 'b1400009-0000-4000-8000-000000000009', 'AboutStoryList1Tr', 'AboutStoryList1', 'TR', 'Brand & art direction', NULL, JSON_OBJECT('items', JSON_ARRAY('Art direction', 'Branding', 'Content Production', 'User Interface Design', 'Animation'))
  ...
  UNION ALL SELECT 'b1400011-0000-4000-8000-000000000011', 'AboutStoryList2Tr', 'AboutStoryList2', 'TR', 'Experience systems', NULL, JSON_OBJECT('items', JSON_ARRAY('Brand Identity', 'User Interface', 'User Experience', 'Responsive Design'))
  ...
  UNION ALL SELECT 'b1400013-0000-4000-8000-000000000013', 'AboutTeamMember1Tr', 'AboutTeamMember1', 'TR', 'Jane Mills', 'Shapes brand systems and visual narratives across launch campaigns and new product work.', JSON_OBJECT('role', 'Art direction', 'mediaUid', 'about-team-1')
  ...
  UNION ALL SELECT 'b1400015-0000-4000-8000-000000000015', 'AboutTeamMember2Tr', 'AboutTeamMember2', 'TR', 'Jim Mathis', 'Translates strategy into clear brand directions, presentation systems, and pitch narratives.', JSON_OBJECT('role', 'Brand strategy', 'mediaUid', 'about-team-2')
  ...
  UNION ALL SELECT 'b1400017-0000-4000-8000-000000000017', 'AboutTeamMember3Tr', 'AboutTeamMember3', 'TR', 'Randolph Cole', 'Builds motion systems and tactile interactions that add rhythm to digital journeys.', JSON_OBJECT('role', 'Motion design', 'mediaUid', 'about-team-3')
  ...
  UNION ALL SELECT 'b1400019-0000-4000-8000-000000000019', 'AboutTeamMember4Tr', 'AboutTeamMember4', 'TR', 'Anna Mullins', 'Designs polished interfaces with a strong editorial eye and durable component thinking.', JSON_OBJECT('role', 'Digital design', 'mediaUid', 'about-team-4')
  ...
  UNION ALL SELECT 'b1400021-0000-4000-8000-000000000021', 'AboutTeamMember5Tr', 'AboutTeamMember5', 'TR', 'Devin Minor', 'Bridges research, messaging, and product storytelling for multi-channel campaigns.', JSON_OBJECT('role', 'Product storytelling', 'mediaUid', 'about-team-5')
  ...
  UNION ALL SELECT 'b1400023-0000-4000-8000-000000000023', 'AboutTeamMember6Tr', 'AboutTeamMember6', 'TR', 'Lucas Gray', 'Connects interface detail with service experience and conversion-focused flows.', JSON_OBJECT('role', 'Experience design', 'mediaUid', 'about-team-6')
  ...
  UNION ALL SELECT 'b1400025-0000-4000-8000-000000000025', 'AboutTeamMember7Tr', 'AboutTeamMember7', 'TR', 'Deborah Jones', 'Writes concise copy and content structures that keep complex stories readable.', JSON_OBJECT('role', 'Copy & content', 'mediaUid', 'about-team-7')
  ...
  UNION ALL SELECT 'b1400027-0000-4000-8000-000000000027', 'AboutTeamMember8Tr', 'AboutTeamMember8', 'TR', 'Miller Stone', 'Pairs design craft with frontend experimentation to turn concepts into usable systems.', JSON_OBJECT('role', 'Creative development', 'mediaUid', 'about-team-8')
  ...
  UNION ALL SELECT 'b1400029-0000-4000-8000-000000000029', 'AboutStat1Tr', 'AboutStat1', 'TR', 'PROJECTS FINISHED', NULL, JSON_OBJECT('statValue', 245, 'statSuffix', '+')
  ...
  UNION ALL SELECT 'b1400031-0000-4000-8000-000000000031', 'AboutStat2Tr', 'AboutStat2', 'TR', 'YEARS OF EXPERIENCE', NULL, JSON_OBJECT('statValue', 17, 'statSuffix', '+')
  ...
  UNION ALL SELECT 'b1400033-0000-4000-8000-000000000033', 'AboutStat3Tr', 'AboutStat3', 'TR', 'TEAM MEMBERS', NULL, JSON_OBJECT('statValue', 9, 'statSuffix', '+')
  ...
  UNION ALL SELECT 'b1400035-0000-4000-8000-000000000035', 'AboutStat4Tr', 'AboutStat4', 'TR', 'GROWING AGENCY', NULL, JSON_OBJECT('statValue', 194, 'statSuffix', '%')
  ...
  UNION ALL SELECT 'b1400037-0000-4000-8000-000000000037', 'AboutBrandLogo1Tr', 'AboutBrandLogo1', 'TR', NULL, NULL, JSON_OBJECT('mediaUid', 'about-brand-1', 'altText', 'Partner logo 1')
  ...
  UNION ALL SELECT 'b1400039-0000-4000-8000-000000000039', 'AboutBrandLogo2Tr', 'AboutBrandLogo2', 'TR', NULL, NULL, JSON_OBJECT('mediaUid', 'about-brand-2', 'altText', 'Partner logo 2')
  ...
  UNION ALL SELECT 'b1400041-0000-4000-8000-000000000041', 'AboutBrandLogo3Tr', 'AboutBrandLogo3', 'TR', NULL, NULL, JSON_OBJECT('mediaUid', 'about-brand-3', 'altText', 'Partner logo 3')
  ...
  UNION ALL SELECT 'b1400043-0000-4000-8000-000000000043', 'AboutBrandLogo4Tr', 'AboutBrandLogo4', 'TR', NULL, NULL, JSON_OBJECT('mediaUid', 'about-brand-4', 'altText', 'Partner logo 4')
  ...
  UNION ALL SELECT 'b1400045-0000-4000-8000-000000000045', 'AboutBrandLogo5Tr', 'AboutBrandLogo5', 'TR', NULL, NULL, JSON_OBJECT('mediaUid', 'about-brand-5', 'altText', 'Partner logo 5')
  ...
  UNION ALL SELECT 'b1400047-0000-4000-8000-000000000047', 'AboutBrandLogo6Tr', 'AboutBrandLogo6', 'TR', NULL, NULL, JSON_OBJECT('mediaUid', 'about-brand-2', 'altText', 'Partner logo 6')
  ...
  UNION ALL SELECT 'b1400049-0000-4000-8000-000000000049', 'AboutAward1Tr', 'AboutAward1', 'TR', 'FWA, Site of the Day', NULL, JSON_OBJECT('subtitle', 'x2', 'date', 'Jun 24, 2024', 'mediaUid', 'homepage-award-1')
  ...
  UNION ALL SELECT 'b1400051-0000-4000-8000-000000000051', 'AboutAward2Tr', 'AboutAward2', 'TR', 'Awwwards Interior Excellence', NULL, JSON_OBJECT('subtitle', 'x3', 'date', 'Nov 24, 2022', 'mediaUid', 'about-award-2')
  ...
  UNION ALL SELECT 'b1400053-0000-4000-8000-000000000053', 'AboutAward3Tr', 'AboutAward3', 'TR', 'Loki boundary pushing year in Review 2022', NULL, JSON_OBJECT('subtitle', 'x1', 'date', 'May 24, 2012', 'mediaUid', 'about-award-3')
  ...
  UNION ALL SELECT 'b1400055-0000-4000-8000-000000000055', 'AboutAward4Tr', 'AboutAward4', 'TR', 'The New Liko Tools Website is Live.', NULL, JSON_OBJECT('subtitle', 'x1', 'date', 'Sep 10, 2021', 'mediaUid', 'about-award-4')
  ...
  UNION ALL SELECT 'b1400057-0000-4000-8000-000000000057', 'AboutAward5Tr', 'AboutAward5', 'TR', 'Digital Agencies Worldwide', NULL, JSON_OBJECT('subtitle', 'x2', 'date', 'Jun 12, 2021', 'mediaUid', 'about-award-5')
  ...
  UNION ALL SELECT 'b1400059-0000-4000-8000-000000000059', 'AboutAward6Tr', 'AboutAward6', 'TR', 'FWA, Site of the Day', NULL, JSON_OBJECT('subtitle', 'x1', 'date', 'Aug 18, 2022', 'mediaUid', 'about-award-6')
...
SELECT 'f0000005-0000-0001-000000000001', 'about-us-tr', p.id, 'TR', 'Hakkımızda', 'About Us', '/about-us', 'PUBLISHED'
FROM pages p
