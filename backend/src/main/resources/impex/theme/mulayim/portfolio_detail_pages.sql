...
SELECT seed.uuid, seed.uid, p.id, seed.language, seed.name, seed.title, seed.canonical_url, 'PUBLISHED'
FROM (
  SELECT 'pd660001-0000-4000-8000-000000000001' AS uuid, 'portfolio-detail-lectus-tr' AS uid, 'portfolio-detail-lectus' AS page_uid, 'TR' AS language, 'Babil Sanat Logo & Kurumsal Kimlik' AS name, 'Babil Sanat Logo & Kurumsal Kimlik | Ahmet Mülayim Grafik Atölye' AS title, '/portfolio/babil-sanat-logo-and-kurumsal-kimlik' AS canonical_url
  UNION ALL SELECT 'pd660002-0000-4000-8000-000000000002', 'portfolio-detail-lectus-en', 'portfolio-detail-lectus', 'EN', 'Babil Sanat Logo & Corporate Identity', 'Babil Sanat Logo & Corporate Identity | Ahmet Mülayim Graphic Studio', '/portfolio/babil-sanat-logo-and-kurumsal-kimlik'
  UNION ALL SELECT 'pd660003-0000-4000-8000-000000000003', 'portfolio-detail-the-stage-tr', 'portfolio-detail-the-stage', 'TR', 'Tufanlar Tohumculuk Logo', 'Tufanlar Tohumculuk Logo | Ahmet Mülayim Grafik Atölye', '/portfolio/tufanlar-tohumculuk-logo'
  UNION ALL SELECT 'pd660004-0000-4000-8000-000000000004', 'portfolio-detail-the-stage-en', 'portfolio-detail-the-stage', 'EN', 'Tufanlar Tohumculuk Logo', 'Tufanlar Tohumculuk Logo | Ahmet Mülayim Graphic Studio', '/portfolio/tufanlar-tohumculuk-logo'
  UNION ALL SELECT 'pd660005-0000-4000-8000-000000000005', 'portfolio-detail-art-direction-tr', 'portfolio-detail-art-direction', 'TR', 'Kns Dış Ticaret Danışmanlık Logo', 'Kns Dış Ticaret Danışmanlık Logo | Ahmet Mülayim Grafik Atölye', '/portfolio/kns-dis-ticaret-danismanlik-logo'
  UNION ALL SELECT 'pd660006-0000-4000-8000-000000000006', 'portfolio-detail-art-direction-en', 'portfolio-detail-art-direction', 'EN', 'Kns Foreign Trade Consultancy Logo', 'Kns Foreign Trade Consultancy Logo | Ahmet Mülayim Graphic Studio', '/portfolio/kns-dis-ticaret-danismanlik-logo'
  UNION ALL SELECT 'pd660007-0000-4000-8000-000000000007', 'portfolio-detail-petit-navire-tr', 'portfolio-detail-petit-navire', 'TR', 'Armin Besi Logo', 'Armin Besi Logo | Ahmet Mülayim Grafik Atölye', '/portfolio/armin-besi-logo'
  UNION ALL SELECT 'pd660008-0000-4000-8000-000000000008', 'portfolio-detail-petit-navire-en', 'portfolio-detail-petit-navire', 'EN', 'Armin Besi Logo', 'Armin Besi Logo | Ahmet Mülayim Graphic Studio', '/portfolio/armin-besi-logo'
  UNION ALL SELECT 'pd660009-0000-4000-8000-000000000009', 'portfolio-detail-big-dream-tr', 'portfolio-detail-big-dream', 'TR', 'Işık Ticaret Askeri Malzeme Logo', 'Işık Ticaret Askeri Malzeme Logo | Ahmet Mülayim Grafik Atölye', '/portfolio/isik-ticaret-askeri-malzeme-logo'
  UNION ALL SELECT 'pd660010-0000-4000-8000-000000000010', 'portfolio-detail-big-dream-en', 'portfolio-detail-big-dream', 'EN', 'Işık Ticaret Military Equipment Logo', 'Işık Ticaret Military Equipment Logo | Ahmet Mülayim Graphic Studio', '/portfolio/isik-ticaret-askeri-malzeme-logo'
  UNION ALL SELECT 'pd660011-0000-4000-8000-000000000011', 'portfolio-detail-the-stage-2-tr', 'portfolio-detail-the-stage-2', 'TR', 'Köktaş İnşaat Logo ve Kartvizit', 'Köktaş İnşaat Logo ve Kartvizit | Ahmet Mülayim Grafik Atölye', '/portfolio/koktas-i-nsaat-logo-ve-kartvizit'
  UNION ALL SELECT 'pd660012-0000-4000-8000-000000000012', 'portfolio-detail-the-stage-2-en', 'portfolio-detail-the-stage-2', 'EN', 'Köktaş İnşaat Logo and Business Card', 'Köktaş İnşaat Logo and Business Card | Ahmet Mülayim Graphic Studio', '/portfolio/koktas-i-nsaat-logo-ve-kartvizit'
  UNION ALL SELECT 'pd660013-0000-4000-8000-000000000013', 'portfolio-detail-big-dream-2-tr', 'portfolio-detail-big-dream-2', 'TR', 'Hasça Kuruyemiş - Kahve Logo Tasarımı', 'Hasça Kuruyemiş - Kahve Logo Tasarımı | Ahmet Mülayim Grafik Atölye', '/portfolio/hasca-kuruyemis-kahve-logo-tasarimi'
  UNION ALL SELECT 'pd660014-0000-4000-8000-000000000014', 'portfolio-detail-big-dream-2-en', 'portfolio-detail-big-dream-2', 'EN', 'Hasça Nuts and Coffee Logo Design', 'Hasça Nuts and Coffee Logo Design | Ahmet Mülayim Graphic Studio', '/portfolio/hasca-kuruyemis-kahve-logo-tasarimi'
  UNION ALL SELECT 'pd660015-0000-4000-8000-000000000015', 'portfolio-detail-big-dream-3-tr', 'portfolio-detail-big-dream-3', 'TR', 'Şen Turistik Logo Tasarımı', 'Şen Turistik Logo Tasarımı | Ahmet Mülayim Grafik Atölye', '/portfolio/sen-turistik-logo-tasarimi'
  UNION ALL SELECT 'pd660016-0000-4000-8000-000000000016', 'portfolio-detail-big-dream-3-en', 'portfolio-detail-big-dream-3', 'EN', 'Şen Turistik Logo Design', 'Şen Turistik Logo Design | Ahmet Mülayim Graphic Studio', '/portfolio/sen-turistik-logo-tasarimi'
) seed
