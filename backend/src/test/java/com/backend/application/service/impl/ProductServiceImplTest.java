...
class ProductServiceImplTest extends BaseServiceTest {
    ...
    class CreateCompositeTests {
        ...
        @Test
        @DisplayName("Should set default currency to TRY when null")
        void createComposite_SetsDefaultCurrency_WhenNull() {
            // Given
            ...
            // When
            productService.createComposite(1L, "SKU-TEST", null, null,
                    null, null, null, translations, null, null, null, null, TEST_USER_ID);

            // Then
            verify(productRepository).save(argThat(product -> "TRY".equals(product.getCurrency())));
        }
        ...
        void createComposite_WithMultipleTranslations_Success() {
            ...
            // When
            Product result = productService.createComposite(1L, "SKU-MULTI", null, null,
                    null, null, null, translations, null, null, null, null, TEST_USER_ID);
    ...
    class UpdateCompositeTests {
        ...
        void updateComposite_AllFields_Success() {
            ...
            // When
            Product result = productService.updateComposite(1L, BigDecimal.valueOf(299.99), "USD",
        ...
        void updateComposite_PartialFields_Success() {
            ...
            Product result = productService.updateComposite(1L, BigDecimal.valueOf(150.00), null,
        ...
        void updateComposite_ThrowsException_WhenProductNotFound() {
            ...
            // When & Then
            assertThatThrownBy(() -> productService.updateComposite(999L, null, null,
                    null, null, null, null, null, null, null, null, TEST_USER_ID))
                    .isInstanceOf(IllegalArgumentException.class)
        ...
        void updateComposite_ThrowsException_WhenResponsiveMediaNotFound() {
            ...
            // When & Then
            assertThatThrownBy(() -> productService.updateComposite(1L, null, null,
