// Lightweight inline SVG icons used across the site.
// Where the original site uses framerusercontent SVGs we keep those PNGs/SVGs in /public and reference them as <img>.
// These icons cover small generic UI marks.
...
export function AppleIcon({ size = 18, ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M17.05 12.04c-.02-2.65 2.16-3.92 2.26-3.98-1.23-1.8-3.15-2.05-3.83-2.08-1.62-.17-3.18.96-4 .96-.83 0-2.11-.94-3.47-.91-1.78.03-3.43 1.04-4.34 2.63-1.86 3.22-.48 7.97 1.34 10.58.88 1.27 1.94 2.7 3.33 2.65 1.34-.06 1.85-.86 3.46-.86 1.61 0 2.07.86 3.48.83 1.44-.02 2.36-1.29 3.24-2.57 1.02-1.47 1.45-2.91 1.47-2.99-.03-.01-2.83-1.08-2.94-4.26zM14.5 4.84c.73-.89 1.22-2.12 1.08-3.35-1.05.04-2.32.7-3.07 1.58-.68.78-1.27 2.03-1.11 3.24 1.17.09 2.37-.59 3.1-1.47z" />
    </svg>
  );
}

export function PlayStoreIcon({ size = 18, ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M3 2.59c0-.42.18-.77.46-.99l11.13 11.13-2.51 2.51L3 5.95V2.59zM4.95 1.6L16.65 13.3l3.45-1.97c1.07-.61 1.07-2.16 0-2.77L4.95 1.6zm-1.49.99v18.77c0 .42.18.77.46.99L15.05 11.31 3.92 2.59zM4.95 22.4l15.15-8.66-3.45-1.97L4.95 22.4z" />
    </svg>
  );
}
...
export function DropletIcon({ size = 16, ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" {...props}>
...
export function SparklesIcon({ size = 16, ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" {...props}>
      ...
      <path d="M18 14l.8 2.4L21 17.2l-2.2.8L18 20l-.8-2-2.2-.8 2.2-.8.8-2.4z" />
    </svg>
  );
}
...
export function HeadsetIcon({ size = 16, ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export function GradCapIcon({ size = 16, ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export function BulbIcon({ size = 16, ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M9 18h6" />
      <path d="M10 22h4" />
...
export function MenuIcon({ size = 16, ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth={1.75} strokeLinecap="round" {...props}>
