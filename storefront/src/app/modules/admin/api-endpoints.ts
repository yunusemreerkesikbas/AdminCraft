...
export const SPA_ENDPOINTS_CONFIG = {
    ...
    commerceAdminNotificationOutbox: 'commerce/admin/notifications/outbox',
    commerceAdminNotificationOutboxByUid: 'commerce/admin/notifications/outbox/${outboxUid}',
    commerceAdminNotificationOutboxRetry: 'commerce/admin/notifications/outbox/${outboxUid}/retry',
    commerceAdminNotificationTemplates: 'commerce/admin/notifications/templates',
    commerceAdminNotificationTemplateByUid: 'commerce/admin/notifications/templates/${templateUid}',
    commerceAdminNotificationTemplatePreview: 'commerce/admin/notifications/templates/${templateUid}/preview',
