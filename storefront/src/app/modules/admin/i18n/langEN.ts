            ...
            dashboard: {
                ...
                security: {
                    ...
                    recaptcha: {
                        ...
                        description: 'Configure Google reCAPTCHA v3 for bot protection on authentication forms.',
                        enabled: 'Enable reCAPTCHA',
                        enabledHint: 'Protect login and password reset forms with invisible reCAPTCHA verification.',
                        siteKey: 'Site Key',
                        siteKeyHint: 'Public site key from Google reCAPTCHA admin console.',
                        secretKey: 'Secret Key',
                        secretKeyHint: 'Private secret key from Google reCAPTCHA admin console. Leave empty to keep existing.',
                        secretKeyPlaceholder: 'Enter new secret key to update',
                        threshold: 'Score Threshold',
                        thresholdHint: 'Minimum score required to pass verification. 0.0 = most lenient, 1.0 = most strict. 0.5 recommended.',
                        info: 'You need to register your domain at Google reCAPTCHA admin console to get your site key and secret key. Use reCAPTCHA v3 (invisible) type.',
                    },
                    messages: {
