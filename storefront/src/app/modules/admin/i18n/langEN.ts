    ...
    admin: {
        ...
        commerce: {
            ...
            messages: {
                ...
                missingOrderRequestUid: 'Order request identifier is missing',
                statusUpdated: 'Order status updated',
                statusUpdateFailed: 'Failed to update order status',
                orderRequestDecided: 'Order request decision saved',
                orderRequestDecisionFailed: 'Failed to save order request decision',
                legalTemplateSaved: 'Legal template saved',
                legalTemplateSaveFailed: 'Failed to save legal template',
                legalTemplatePreviewFailed: 'Failed to generate legal template preview',
                notificationTemplateSaved: 'Notification template saved',
                notificationTemplateSaveFailed: 'Failed to save notification template',
                notificationTemplatePreviewFailed: 'Failed to generate notification template preview',
                missingNotificationOutboxUid: 'Notification outbox identifier is missing',
                notificationRetryCompleted: 'Notification retry completed',
                notificationRetryFailed: 'Failed to retry notification',
            },
            dashboard: {
                title: 'Commerce Dashboard',
                subtitle: 'A quick view of order and payment operations',
                ...
                failedNotificationsHint: 'Customer emails waiting for review',
            },
            orders: {
                title: 'Orders',
                subtitle: 'Review customer orders and operational flags',
                searchPlaceholder: 'Search order, customer, email, or payment ID',
                empty: 'No orders yet',
                fields: {
                    orderNumber: 'Order',
                    customer: 'Customer',
            ...
            orderDetail: {
                title: 'Order Detail',
                subtitle: 'Order, payment, address, and operational details',
                items: 'Order Items',
                itemsCount: 'items',
                variant: 'Variant',
                quantity: 'Qty',
                ...
                statusHistoryHint: 'Order status changes and operational notes',
                noStatusHistory: 'No status history yet',
                noActions: 'No pending operational action for this order',
                stockDeducted: 'Stock deducted',
                legalSnapshotStatus: 'Legal snapshot',
                legalSnapshot: 'Legal Snapshot',
                noLegalSnapshot: 'No captured legal snapshot',
                attention: 'Attention',
                actions: {
            ...
            legalTemplates: {
                ...
                subtitle: 'Manage published checkout legal text versions',
                type: 'Type',
                language: 'Language',
                status: 'Status',
                preview: 'Preview',
            ...
            paymentAttempts: {
                ...
                subtitle: 'Monitor successful and failed payment attempts',
                searchPlaceholder: 'Search attempt, customer, provider, or transaction ID',
            ...
            orderRequests: {
                ...
                subtitle: 'Review cancellation, return, and refund decisions',
                detailTitle: 'Order Request',
                detailSubtitle: 'Request details, refund state, and decision controls',
                searchPlaceholder: 'Search request, order, customer, or reason',
                empty: 'No order requests',
                refund: 'Refund',
                decision: 'Decision',
                noDecisionNote: 'No decision note',
                fields: {
                    orderNumber: 'Order',
                    customer: 'Customer',
                    type: 'Type',
                    ...
                    refundFailureCode: 'Failure code',
            ...
            notificationOutbox: {
                ...
                empty: 'No notification outbox entries',
                delivery: 'Delivery',
                error: 'Error',
                filters: {
                    status: 'Status',
                    ...
                    aggregateUidPlaceholder: 'Press Enter to filter',
                    clear: 'Clear filters',
                },
                status: {
                    failed: 'Failed',
                ...
                events: {
                    ...
                    adminOrderCreated: 'Admin: new order',
                    adminOrderRequestCreated: 'Admin: new request',
                    adminPaymentOperationFailed: 'Admin: payment/refund failure',
                },
                fields: {
            ...
            notificationTemplates: {
                ...
                inactiveHint: 'Inactive templates do not create outbox entries for that language and do not fall back to EN.',
                events: {
                    ORDER_PAID: 'Order paid',
                    ORDER_SHIPPED: 'Order shipped',
                    ORDER_REQUEST_CREATED: 'Request created',
                    ORDER_REQUEST_APPROVED: 'Request approved',
                    ORDER_REQUEST_REJECTED: 'Request rejected',
                    ADMIN_ORDER_CREATED: 'Admin: new order',
                    ADMIN_ORDER_REQUEST_CREATED: 'Admin: new request',
                    ADMIN_PAYMENT_OPERATION_FAILED: 'Admin: payment/refund failure',
                },
            },
        },
        nav: {
            ...
            categories: 'Categories',
            commerce: 'Commerce',
            commerceSubtitle: 'Order and payment operations',
            commerceDashboard: 'Commerce Dashboard',
            commerceOrders: 'Orders',
            commercePaymentAttempts: 'Payment Attempts',
            commerceOrderRequests: 'Order Requests',
            commerceNotificationOutbox: 'Notifications',
            commerceNotificationTemplates: 'Notification Templates',
            commerceLegalTemplates: 'Legal Templates',
            ...
            platformOutreachContacts: 'Contacts',
            platformOutreachTemplates: 'Templates',
            platformOutreachCampaigns: 'Campaigns',
        ...
        outreach: {
            contacts: {
                title: 'Platform Outreach Contacts',
                subtitle: 'Manage B2B outreach contact records',
                dialog: {
            ...
            templates: {
                ...
                subtitle: 'Manage outreach email templates and variables',
                dialog: {
            ...
            campaigns: {
                ...
                subtitle: 'Create and send outreach campaigns to contacts',
                dialog: {
                ...
                messages: {
                    ...
                    noDataHint: 'Create a campaign to send outreach emails',
                    confirmSend:
                        'Send campaign "{{name}}" now? This will email all selected contacts.',
                    contactsRequired: 'Select at least one contact.',
                },
                outbox: {
                    title: 'Campaign Outbox',
                    loadError: 'Failed to load outbox details',
                    noEntries: 'No outbox entries yet',
                    subject: 'Subject',
                    error: 'Error',
                },
            },
