            ...
            dashboard: {
                ...
                security: {
                    ...
                    recaptcha: {
                        ...
                        description: 'Kimlik doğrulama formlarında bot koruması için Google reCAPTCHA v3 yapılandırması.',
                        enabled: 'reCAPTCHA Etkinleştir',
                        enabledHint: 'Giriş ve şifre sıfırlama formlarını görünmez reCAPTCHA doğrulaması ile koruyun.',
                        siteKey: 'Site Anahtarı',
                        siteKeyHint: 'Google reCAPTCHA yönetim konsolundan alınan genel site anahtarı.',
                        secretKey: 'Gizli Anahtar',
                        secretKeyHint: 'Google reCAPTCHA yönetim konsolundan alınan özel gizli anahtar. Mevcut anahtarı korumak için boş bırakın.',
                        secretKeyPlaceholder: 'Güncellemek için yeni gizli anahtar girin',
                        threshold: 'Skor Eşiği',
                        thresholdHint: 'Doğrulamayı geçmek için gereken minimum skor. 0.0 = en esnek, 1.0 = en katı. 0.5 önerilir.',
                        info: 'Site anahtarınızı ve gizli anahtarınızı almak için alan adınızı Google reCAPTCHA yönetim konsoluna kaydetmeniz gerekir. reCAPTCHA v3 (görünmez) türünü kullanın.',
                    },
                    messages: {
                ...
                technical: {
                    ...
                    scripts: "Özel Script'ler",
                    scriptsDesc: "Analitik veya tracking script'leri ekleyin",
                    headScripts: "Head Script'leri",
                    headScriptsHint: "<head> içine enjekte edilecek script'ler",
                    bodyStartScripts: "Body Başlangıç Script'leri",
                    bodyEndScripts: "Body Bitiş Script'leri",
                    bodyEndScriptsHint:
                        '</body> etiketinden önce enjekte edilecek',
