    ...
    admin: {
        ...
        commerce: {
            ...
            messages: {
                ...
                missingOrderRequestUid: 'Sipariş talebi tanımlayıcısı eksik',
                statusUpdated: 'Sipariş durumu güncellendi',
                statusUpdateFailed: 'Sipariş durumu güncellenemedi',
                orderRequestDecided: 'Sipariş talep kararı kaydedildi',
                orderRequestDecisionFailed: 'Sipariş talep kararı kaydedilemedi',
                legalTemplateSaved: 'Yasal şablon kaydedildi',
                legalTemplateSaveFailed: 'Yasal şablon kaydedilemedi',
                legalTemplatePreviewFailed: 'Yasal şablon önizlemesi oluşturulamadı',
                notificationTemplateSaved: 'Bildirim şablonu kaydedildi',
                notificationTemplateSaveFailed: 'Bildirim şablonu kaydedilemedi',
                notificationTemplatePreviewFailed: 'Bildirim şablonu önizlemesi oluşturulamadı',
                missingNotificationOutboxUid: 'Bildirim outbox tanımlayıcısı eksik',
                notificationRetryCompleted: 'Bildirim tekrar gönderimi tamamlandı',
                notificationRetryFailed: 'Bildirim tekrar gönderilemedi',
            },
            dashboard: {
                title: 'Commerce Paneli',
                subtitle: 'Sipariş ve ödeme operasyonlarının hızlı özeti',
                ...
                failedNotificationsHint: 'Kontrol bekleyen müşteri e-postaları',
            },
            orders: {
                title: 'Siparişler',
                subtitle: 'Müşteri siparişlerini ve operasyon notlarını inceleyin',
                searchPlaceholder: 'Sipariş, müşteri, e-posta veya ödeme ID ara',
            ...
            orderDetail: {
                ...
                subtitle: 'Sipariş, ödeme, adres ve operasyon detayları',
                ...
                providerReference: 'Provider referansı',
                providerTransactionId: 'Provider işlem ID',
                operational: 'Operasyon',
                operations: 'Operasyon Aksiyonları',
                currentStatus: 'Mevcut durum',
                carrierName: 'Kargo firması',
                ...
                statusHistoryHint: 'Sipariş durum değişiklikleri ve operasyon notları',
                noStatusHistory: 'Henüz durum geçmişi yok',
                noActions: 'Bu sipariş için bekleyen operasyon aksiyonu yok',
                stockDeducted: 'Stok düşüldü',
                legalSnapshotStatus: 'Legal snapshot',
                legalSnapshot: 'Yasal Snapshot',
                noLegalSnapshot: 'Kaydedilmiş yasal snapshot yok',
                attention: 'Dikkat',
                actions: {
                    markPreparing: 'Hazırlanıyor olarak işaretle',
            ...
            legalTemplates: {
                title: 'Yasal Şablonlar',
                subtitle: 'Checkout yasal metin versiyonlarını yönetin',
                type: 'Tip',
                language: 'Dil',
                status: 'Durum',
                preview: 'Önizleme',
                publish: 'Yayınla',
                archive: 'Arşivle',
                empty: 'Yasal şablon yok',
                editTitle: 'Şablonu düzenle',
                createTitle: 'Yeni şablon',
                formTitle: 'Başlık',
                content: 'İçerik',
            ...
            paymentAttempts: {
                ...
                subtitle: 'Başarılı ve başarısız ödeme girişimlerini izleyin',
                searchPlaceholder: 'Deneme, müşteri, provider veya işlem ID ara',
                empty: 'Ödeme denemesi yok',
                fields: {
                    attempt: 'Deneme',
                    customer: 'Müşteri',
                    status: 'Durum',
            ...
            orderRequests: {
                ...
                subtitle: 'İptal, iade ve refund kararlarını inceleyin',
                detailTitle: 'Sipariş Talebi',
                detailSubtitle: 'Talep detayı, refund durumu ve karar kontrolleri',
                searchPlaceholder: 'Talep, sipariş, müşteri veya neden ara',
                empty: 'Sipariş talebi yok',
                refund: 'Refund',
                decision: 'Karar',
                noDecisionNote: 'Karar notu yok',
                fields: {
                    orderNumber: 'Sipariş',
                    customer: 'Müşteri',
                    type: 'Tip',
                    status: 'Durum',
                    refundStatus: 'Refund durumu',
                    refundReference: 'Refund referansı',
                    refundFailureCode: 'Hata kodu',
                    stockRestored: 'Stok geri eklendi',
                    total: 'Toplam',
                    previousStatus: 'Önceki durum',
                    requestedStatus: 'Talep durumu',
                    decisionNote: 'Karar notu',
                    decidedBy: 'Kararı veren',
                    decidedAt: 'Karar zamanı',
                    createdAt: 'Tarih',
                },
                actions: {
                    approve: 'Onayla ve iade et',
                    reject: 'Reddet',
                },
            },
            notificationOutbox: {
                ...
                empty: 'Bildirim outbox kaydı yok',
                delivery: 'Gönderim',
                error: 'Hata',
                filters: {
                    status: 'Durum',
                ...
                events: {
                    ...
                    orderShipped: 'Sipariş kargolandı',
                    requestCreated: 'Talep oluşturuldu',
                    requestApproved: 'Talep onaylandı',
                    requestRejected: 'Talep reddedildi',
                    adminOrderCreated: 'Admin: yeni sipariş',
                    adminOrderRequestCreated: 'Admin: yeni talep',
                    adminPaymentOperationFailed: 'Admin: ödeme/iade hatası',
                },
                fields: {
            ...
            notificationTemplates: {
                ...
                preview: 'Önizleme',
                empty: 'Bildirim şablonu yok',
                editTitle: 'Şablonu düzenle',
                subject: 'Konu',
                content: 'İçerik',
                selectHint: 'Düzenlemek için bir şablon seçin',
                inactiveHint: 'Pasif şablonlar için ilgili dilde outbox oluşturulmaz ve EN fallback yapılmaz.',
                events: {
                    ORDER_PAID: 'Sipariş ödendi',
                    ORDER_SHIPPED: 'Sipariş kargolandı',
                    ORDER_REQUEST_CREATED: 'Talep oluşturuldu',
                    ORDER_REQUEST_APPROVED: 'Talep onaylandı',
                    ORDER_REQUEST_REJECTED: 'Talep reddedildi',
                    ADMIN_ORDER_CREATED: 'Admin: yeni sipariş',
                    ADMIN_ORDER_REQUEST_CREATED: 'Admin: yeni talep',
                    ADMIN_PAYMENT_OPERATION_FAILED: 'Admin: ödeme/iade hatası',
                },
            },
        },
        nav: {
            ...
            categories: 'Kategoriler',
            commerce: 'Commerce',
            commerceSubtitle: 'Sipariş ve ödeme operasyonları',
            commerceDashboard: 'Commerce Paneli',
            commerceOrders: 'Siparişler',
            commercePaymentAttempts: 'Ödeme Denemeleri',
            commerceOrderRequests: 'Sipariş Talepleri',
            commerceNotificationOutbox: 'Bildirimler',
            commerceNotificationTemplates: 'Bildirim Şablonları',
            commerceLegalTemplates: 'Yasal Şablonlar',
